...
using _SwitchDefaultHandle = simple::type::Switch<std::false_type,
	decltype(simple::_helper::_cont::_handle::_data::
...
using _HasDefaultHandle = std::integral_constant<bool,
	simple::_helper::_cont::_handle::_data::
		_SwitchDefaultHandle<Tc, Tr, Targs...>::Index !=
	simple::_helper::_cont::_handle::_data::
		_SwitchDefaultHandle<Tc, Tr, Targs...>::Size>;

template<typename Tc, typename Tr, typename... Targs>
typename std::enable_if<simple::_helper::_cont::_handle::_data::
...
struct DataIDConst : simple::IdentifierConstant {};

template<typename Tidc, typename Tc, typename Tr, typename... Targs>
class Data : public simple::Handle<simple::cont::handle::DataIDConst,
	Tr, Tc&, Targs...>
{
public:
	typedef typename simple::id_const::Validation<Tidc>::Type IDConstType;
	typedef typename simple::Handle<simple::cont::handle::DataIDConst,
		Tr, Tc&, Targs...>::FunctionType HandleType;
private:
	typedef simple::Handle<simple::cont::handle::DataIDConst,
		Tr, Tc&, Targs...> BaseHandleType;
public:
	Data();
	Data(HandleType handle);
	Data(const Data<Tidc, Tc, Tr, Targs...>& cpy);
	Data(Data<Tidc, Tc, Tr, Targs...>&& mov);
public:
	Data<Tidc, Tc, Tr, Targs...>& 
		operator=(const Data<Tidc, Tc, Tr, Targs...>& cpy);
	Data<Tidc, Tc, Tr, Targs...>&
...
template<typename Tidc, typename Tc, typename Tr, typename... Targs>
Data<Tidc, Tc, Tr, Targs...>::Data()
{
	if (simple::_helper::_cont::_handle::_data::
		_HasDefaultHandle<Tc, Tr, Targs...>::value)
			Set(&simple::_helper::_cont::_handle::_data::
				_DefaultHandle<Tc, Tr, Targs...>);
}

template<typename Tidc, typename Tc, typename Tr, typename... Targs>
Data<Tidc, Tc, Tr, Targs...>::Data(HandleType handle) :
...
template<typename Tidc, typename Tc, typename Tr, typename... Targs>
Data<Tidc, Tc, Tr, Targs...>& Data<Tidc, Tc, Tr, Targs...>::
	operator=(const Data<Tidc, Tc, Tr, Targs...>& cpy)
{
...
template<typename Tidc, typename Tc, typename Tr, typename... Targs>
Data<Tidc, Tc, Tr, Targs...>& 
    Data<Tidc, Tc, Tr, Targs...>::operator=(HandleType handle)
{
...
template<typename Tidc, typename Tc, typename Tr, typename... Targs>
Data<Tidc, Tc, Tr, Targs...>::operator bool() const
{

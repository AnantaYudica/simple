...
struct _Validation
{
	static constexpr bool _HasFunctionMember0 =
		decltype(simple::_helper::_sort::_IsHasFunctionMember0<Tc, Targs...>
			(std::declval<Tc>()))::value;
	static constexpr bool _HasFunctionMember1 =
		decltype(simple::_helper::_sort::_IsHasFunctionMember1<Tc, Targs...>
			(std::declval<Tc>()))::value;
	...
	static constexpr bool _HasFunctionPointer0 =
		decltype(simple::_helper::_sort::_IsHasFunctionPointer0<Tc, Targs...>
			(std::declval<Tc>()))::value;
	static constexpr bool _HasFunctionPointer1 =
		decltype(simple::_helper::_sort::_IsHasFunctionPointer1<Tc, Targs...>
			(std::declval<Tc>()))::value;
...
{
	if (simple::_helper::_sort::_Validation<Tc, Tr, Targs...>::_HasFunction)
	{
		Set(&simple::_helper::_sort::_Call::DefaultHandle<Tc, Tr, Targs...>);
	}
}

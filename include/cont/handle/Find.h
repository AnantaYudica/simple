...
struct _Validation
{
	static constexpr bool _HasFunctionMember0 =
		decltype(simple::_helper::_find::_IsHasFunctionMember0<Tc, Targs...>
			(std::declval<Tc>()))::value;
	static constexpr bool _HasFunctionMember1 =
		decltype(simple::_helper::_find::_IsHasFunctionMember1<Tc, Targs...>
			(std::declval<Tc>()))::value;
	...
	static constexpr bool _HasFunctionPointer0 =
		decltype(simple::_helper::_find::_IsHasFunctionPointer0<Tc, Targs...>
			(std::declval<Tc>()))::value;
	static constexpr bool _HasFunctionPointer1 =
		decltype(simple::_helper::_find::_IsHasFunctionPointer1<Tc, Targs...>
			(std::declval<Tc>()))::value;
...
class Find : public simple::Handle<FindKey, Tr, Tc&, Targs...>
{
public:
	typedef K KeyType;
...
public:
	...
	Find(const Find<K, Tc, Tr, Targs...>& cpy);
	Find(Find<K, Tc, Tr, Targs...>&& mov);
public:
	Find<K, Tc, Tr, Targs...>& 
		operator=(const Find<K, Tc, Tr, Targs...>& cpy);
	Find<K, Tc, Tr, Targs...>&
...
template<typename K, typename Tc, typename Tr, typename... Targs>
Find<K, Tc, Tr, Targs...>::Find()
{
	if (simple::_helper::_find::_Validation<Tc, Tr, Targs...>::_HasFunction)
	{
		Set(&simple::_helper::_find::_Call::DefaultHandle<Tc, Tr, Targs...>);
	}
}

template<typename K, typename Tc, typename Tr, typename... Targs>
Find<K, Tc, Tr, Targs...>::Find(HandleType handle) :
	simple::Handle<FindKey, Tr, Tc&, Targs...>(handle)
{}  

template<typename K, typename Tc, typename Tr, typename... Targs>
Find<K, Tc, Tr, Targs...>::
	Find(const Find<K, Tc, Tr, Targs...>& cpy) :
		simple::Handle<FindKey, Tr, Tc&, Targs...>(cpy)
{}

template<typename K, typename Tc, typename Tr, typename... Targs>
Find<K, Tc, Tr, Targs...>::
	Find(Find<K, Tc, Tr, Targs...>&& mov) :
		simple::Handle<FindKey, Tr, Tc&, Targs...>(mov)
{}

template<typename K, typename Tc, typename Tr, typename... Targs>
Find<K, Tc, Tr, Targs...>& Find<K, Tc, Tr, Targs...>::
	operator=(const Find<K, Tc, Tr, Targs...>& cpy)
{
	simple::Handle<FindKey, Tr, Tc&, Targs...>::operator=(cpy);
	return *this;
}
...
Find<K, Tc, Tr, Targs...>& Find<K, Tc, Tr, Targs...>::
	operator=(HandleType handle)
{
	simple::Handle<FindKey, Tr, Tc&, Targs...>::operator=(handle);
	return *this;
}

template<typename K, typename Tc, typename Tr, typename... Targs>
Tr Find<K, Tc, Tr, Targs...>::operator()(Tc& cont, Targs... val_args)
{
    return simple::Handle<FindKey, Tr, Tc&, Targs...>
		::operator()(cont, val_args...);
}

template<typename K, typename Tc, typename Tr, typename... Targs>
Find<K, Tc, Tr, Targs...>::operator bool() const
{
	return simple::Handle<FindKey, Tr, Tc&, Targs...>::operator bool();
}

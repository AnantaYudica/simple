...
{
	if (simple::_helper::_bucket::_HasDefaultHandle<K, Tc, Tr, Targs...>::value)
		Set(&simple::_helper::_bucket::_DefaultHandle<K, Tc, Tr, Targs...>);
}

...
using _SwitchDefaultHandle = simple::type::Switch<std::false_type,
	decltype(simple::_helper::_cont::_handle::_bucket_size::
...
using _HasDefaultHandle = std::integral_constant<bool,
	simple::_helper::_cont::_handle::_bucket_size::
		_SwitchDefaultHandle<Tc, Tr, Targs...>::Index !=
	simple::_helper::_cont::_handle::_bucket_size::
		_SwitchDefaultHandle<Tc, Tr, Targs...>::Size>;

template<typename Tc, typename Tr, typename... Targs>
typename std::enable_if<simple::_helper::_cont::_handle::_bucket_size::
...
struct BucketSizeIDConst : simple::IdentifierConstant {};

template<typename Tidc, typename Tc, typename Tr, typename... Targs>
class BucketSize : public simple::Handle<simple::cont::handle::
	BucketSizeIDConst, Tr, Tc&, Targs...>
{
public:
	typedef typename simple::id_const::Validation<Tidc>::Type IDConstType;
	typedef typename simple::Handle<simple::cont::handle::
		BucketSizeIDConst, Tr, Tc&, Targs...>::FunctionType HandleType;
private:
	typedef simple::Handle<simple::cont::handle::
		BucketSizeIDConst, Tr, Tc&, Targs...> BaseHandleType;
public:
	BucketSize();
	BucketSize(HandleType handle);
	BucketSize(const BucketSize<Tidc, Tc, Tr, Targs...>& cpy);
	BucketSize(BucketSize<Tidc, Tc, Tr, Targs...>&& mov);
public:
	BucketSize<Tidc, Tc, Tr, Targs...>& 
		operator=(const BucketSize<Tidc, Tc, Tr, Targs...>& cpy);
	BucketSize<Tidc, Tc, Tr, Targs...>&
...
template<typename Tidc, typename Tc, typename Tr, typename... Targs>
BucketSize<Tidc, Tc, Tr, Targs...>::BucketSize()
{
	if (simple::_helper::_cont::_handle::_bucket_size::
		_HasDefaultHandle<Tc, Tr, Targs...>::value)
			Set(&simple::_helper::_cont::_handle::_bucket_size::
				_DefaultHandle<Tc, Tr, Targs...>);
}

template<typename Tidc, typename Tc, typename Tr, typename... Targs>
BucketSize<Tidc, Tc, Tr, Targs...>::BucketSize(HandleType handle) :
...
template<typename Tidc, typename Tc, typename Tr, typename... Targs>
BucketSize<Tidc, Tc, Tr, Targs...>& BucketSize<Tidc, Tc, Tr, Targs...>::
	operator=(const BucketSize<Tidc, Tc, Tr, Targs...>& cpy)
{
...
template<typename Tidc, typename Tc, typename Tr, typename... Targs>
Tr BucketSize<Tidc, Tc, Tr, Targs...>::operator()(Tc& cont, Targs... val_args)
{
    return BaseHandleType::operator()(cont, val_args...);
}

template<typename Tidc, typename Tc, typename Tr, typename... Targs>
BucketSize<Tidc, Tc, Tr, Targs...>::operator bool() const
{
